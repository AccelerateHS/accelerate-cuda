...
module Data.Array.Accelerate.CUDA.ExecuteSimpleCUDA (

  -- * Execute a computation under a CUDA environment
  executeSimpleAcc --  executeAfun1
...
executeSimpleAcc :: ExecAcc -> CIO [[SA.AccArray]]
executeSimpleAcc !acc = undefined -- stre1aming (executeOpenAcc acc Aempty) wait
